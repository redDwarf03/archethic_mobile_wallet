...
class PreferencesHiveDatasource {
  ...
  static const String devMode = 'archethic_wallet_devMode';
  ...
  Future<void> setDevMode(bool value) => _setValue(devMode, value);

  bool getDevMode() => _getValue(devMode, defaultValue: false);
